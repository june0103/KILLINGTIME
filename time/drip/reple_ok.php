...
$sql = mq("insert into driprep(con_num,name,userid,content,date) values('".$bno."','".$name."','".$userid."','".$_POST['content']."','".$date."')");
?>
<script type="text/javascript" src="common.js"></script>

<h3>댓글목록</h3>
  <?php
    $sql3 = mq("select * from driprep where con_num='".$bno."' order by idx desc");
