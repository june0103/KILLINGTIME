        ...
        <table class="list-table">
          <thead>
            ...
            if(isset($_GET['page'])){
              ...
              $sql = mq("select * from video order by idx desc limit  $start_num, $list"); // board테이블에있는 idx를 기준으로 내림차순해서 %%개까지 표시
                while($board = $sql->fetch_array())
                {
                  ...
                  $sql2 = mq("select * from videorep where con_num='".$board['idx']."'"); //reply테이블에서 con_num이 board의 idx와 같은 것을 선택
