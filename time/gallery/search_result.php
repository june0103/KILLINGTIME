...
$title = "title";
  ...
  setcookie('gcatagory' , $catagory , time()+60*60*24, "/");
  setcookie('gsearch_con' , $search_con , time()+60*60*24, "/");

if($_GET['catagory'] ==null && $_GET['search'] == null)
{
  $catagory = $_COOKIE[gcatagory];
  $search_con = $_COOKIE[gsearch_con];
  setcookie('gcatagory' , $catagory , time()+360000, "/");
  setcookie('gsearch_con' , $search_con , time()+360000, "/");
}

?>
<h3 style="color:#509ee7;
  margin-top: 10px;
  margin-bottom: 20px;">사진 공간</h3>
      ...
      <thead>
        ...
        if(isset($_GET['page'])){
             $page = $_GET['page'];
                 ...
                 $sql = mq("select * from gallery where $catagory like '%$search_con%'");
          ...
          $sql2 = mq("select * from gallery where $catagory like '%$search_con%' order by idx desc limit $start_num, $list");
          ...
          $title=$board["title"];
            ...
            $sql3 = mq("select * from galleryrep where con_num='".$board['idx']."'");
